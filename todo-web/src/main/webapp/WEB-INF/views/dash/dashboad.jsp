			...
			<section class="col-lg-7 connectedSortable">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">
							<i class="fas fa-chart-pie mr-1"></i> 売上
						</h3>
					...
					<div class="card-body">
						...
						<div class="direct-chat-contacts">
							<ul class="contacts-list">
								...
								<!-- End Contact Item -->
								<li><a href="#"> <img class="contacts-list-img"
										src="${pageContext.request.contextPath}/resources/app/img/user7-128x128.jpg"
										alt="User Avatar">
								...
								<!-- End Contact Item -->
								<li><a href="#"> <img class="contacts-list-img"
										src="${pageContext.request.contextPath}/resources/app/img/user5-128x128.jpg"
										alt="User Avatar">
								...
								<!-- End Contact Item -->
								<li><a href="#"> <img class="contacts-list-img"
										src="${pageContext.request.contextPath}/resources/app/img/user6-128x128.jpg"
										alt="User Avatar">
			...
			<section class="col-lg-5 connectedSortable">
				...
				<div class="card bg-gradient-primary">
					<div class="card-header border-0">
						<h3 class="card-title">
							<i class="fas fa-map-marker-alt mr-1"></i> 地域別訪問者
						</h3>
						<!-- card tools -->
						<div class="card-tools">
				...
				<div class="card bg-gradient-success">
					<div class="card-header border-0">
						...
						<h3 class="card-title">
							<i class="far fa-calendar-alt"></i> カレンダー
						</h3>
						<!-- tools card -->
						<div class="card-tools">
